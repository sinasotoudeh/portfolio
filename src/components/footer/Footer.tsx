...
const SOCIAL_LINKS = [
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/sinasotoudeh', icon: 'linkedin' },
  { label: 'GitHub', href: 'https://github.com/sinasotoudeh', icon: 'github' },
  { label: 'Instagram', href: 'https://www.instagram.com/sina.sotoude/', icon: 'instagram' },
];
      ...
      <div className={styles.footerInner}>
        ...
        <div className={styles.linksGrid}>
          ...
          <div className={styles.brandSection} style={{ '--col-index': FOOTER_SECTIONS.length } as React.CSSProperties}>
            <div className={styles.logo}>
              <span className={styles.logoText}>SINA&nbsp;</span>
              <span className={styles.logoAccent}>SO</span>
              <span className={styles.logoText}>TOUDEH</span>
            </div>
        ...
        <div className={styles.footerBottom}>
          ...
          <div className={styles.copyright}>
            <span>© {new Date().getFullYear()} Sina Sotoudeh. All rights reserved.</span>
          </div>
